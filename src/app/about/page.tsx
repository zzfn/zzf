...
const StatCard = ({
  ...
  <div className='border-border-muted bg-bg-default flex flex-col gap-2 rounded-2xl border p-4'>
  ...
  return (
    <div className='bg-bg-default text-fg-default min-h-screen px-4 py-8'>
      <div className='mx-auto max-w-5xl space-y-8'>
        ...
        {/* 概览部分 */}
        <div className='border-jan-ink bg-bg-default rounded-2xl border-2 p-6 shadow-[3px_3px_0_var(--color-jan-ink)]'>
