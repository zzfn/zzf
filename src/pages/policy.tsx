  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          Hosting, distributing or linking to child pornography or content that
      ...
      <p>
        ...
        and Services or use the Website and Services in any way which results in
      ...
      <p>
        ...
        unsolicited messages. We maintain a zero tolerance policy for use of the
        ...
        or unsolicited commercial e-mail, or the sending, assisting, or
        commissioning the transmission of commercial e-mail that does not comply
        with the U.S. CAN-SPAM Act of 2003 (&quot;SPAM&quot;).
      </p>
      <p>
        Your products or services advertised via SPAM (i.e. Spamvertised) may
        not be used in conjunction with the Website and Services. This provision
        includes, but is not limited to, SPAM sent via fax, phone, postal mail,
        email, instant messaging, or newsgroups.
      </p>
      <p>
        Sending emails through the Website and Services to purchased email lists
        (&quot;safe lists&quot;) will be treated as SPAM.
      </p>
      <h2>Defamation and objectionable content</h2>
      <p>
        We value the freedom of expression and encourage Users to be respectful
        with the content they post. We are not a publisher of User content and
        are not in a position to investigate the veracity of individual
        defamation claims or to determine whether certain material, which we may
        find objectionable, should be censored. However, we reserve the right to
        moderate, disable or remove any content to prevent harm to others or to
        us or the Website and Services, as determined in our sole discretion.
      </p>
      <h2>Copyrighted content</h2>
      <p>
        Copyrighted material must not be published via the Website and Services
        ...
        Upon receipt of a claim for copyright infringement, or a notice of such
        violation, we may, at our discretion, run an investigation and, upon
        confirmation, may remove the infringing material from the Website and
        Services. We may terminate the Service of Users with repeated copyright
        ...
        removal of any such material. If you believe your copyright is being
        infringed by a person or persons using the Website and Services, please
        get in touch with us to report copyright infringement.
      </p>
      <h2>Security</h2>
      <p>
        ...
        updating any login account provided to you for the Website and Services.
        You must protect the confidentiality of your login details, and you
      ...
      <ul>
        ...
        <li>
          ...
          including to prevent harm to others or to us or the Website and
      ...
      <p>
        ...
        email to &#97;d&#109;&#105;n&#64;&#122;zfz&#122;&#102;.c&#111;&#109;
      </p>
      <p>This document was last updated on August 24, 2020</p>
    </div>
  );
}
