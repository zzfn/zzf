        ...
        <div className='flex flex-col gap-10 md:flex-row md:justify-between'>
          <div className='space-y-5'>
            ...
            <div className='grid grid-cols-1 gap-2 text-sm sm:grid-cols-2'>
              <Link
                className='group flex items-center gap-2 rounded-full px-3 py-2 text-fg-muted transition-colors hover:text-fg-accent'
                href='/api/feed.xml'
              >
          ...
          <div className='space-y-5'>
            ...
            <div className='text-fg-muted space-y-3 text-sm'>
              ...
              <a
                className='hover:text-fg-accent block text-fg-muted transition-colors'
                rel='noreferrer'
                target='_blank'
