  ...
  return (
    <button
      ...
      className={classNames(
        'bg-accent inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-[color:var(--fgColor-onEmphasis)] transition-colors duration-200',
