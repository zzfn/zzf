    ...
    return (
      <button
        ...
        className={classNames(
          'text-muted grid h-8 w-8 place-content-center rounded-md border border-transparent bg-transparent transition-colors duration-200 ease-[cubic-bezier(0.3,0,0.5,1)]',
          'p-0',
